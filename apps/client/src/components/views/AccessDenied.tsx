    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-16 flex flex-col items-center">
        ...
        <div className="grid sm:grid-cols-2 gap-4 w-full max-w-md">
          <Card className="flex flex-col items-center p-6 text-center hover:border-primary-300 transition-colors cursor-pointer group">
            <MessageCircle className="w-8 h-8 text-primary-500 mb-3 group-hover:scale-110 transition-transform" />
          ...
          <Card 
            onClick={() => logout()}
            className="flex flex-col items-center p-6 text-center hover:border-rose-300 transition-colors cursor-pointer group"
          >
