  ...
  return (
    <div className="relative flex-1">
      ...
      {showDropdown && filteredUsers.length > 0 && (
        <div className="absolute bottom-full left-0 mb-1 z-50 bg-background border border-border rounded-md shadow-lg overflow-hidden min-w-[180px] max-w-[280px] max-h-[200px] overflow-y-auto">
