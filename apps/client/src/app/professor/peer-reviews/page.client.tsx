...
import type { PeerReviewSessionListItem } from '@/lib/types';
...
export default function ProfessorPeerReviewsPageClient() {
  ...
  const loadSessions = useCallback(async () => {
    ...
    try {
      const response = await peerReviewsApi.listSessions();
