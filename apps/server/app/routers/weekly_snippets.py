...
async def organize_weekly_snippet(
    ...
    async def _event_stream():
        ...
        try:
            ...
            async for chunk in _snippet_utils.organize_content_with_ai_stream(
                source_content,
                copilot,
                prompt_name=prompt_name,
...
async def generate_weekly_snippet_feedback(
    ...
    async def _event_stream():
        ...
        try:
            ...
            async for chunk in _snippet_utils.generate_feedback_with_ai_stream(
                snippet_content=content,
                playbook_content=playbook_content,
                copilot=copilot,
                prompt_name="weekly_feedback.md",
...
async def update_weekly_snippet(
    ...
    async with AsyncSessionLocal() as db:
        ...
        updated = await crud.update_weekly_snippet(
            db,
            snippet=snippet,
            content=payload.content,
        )
