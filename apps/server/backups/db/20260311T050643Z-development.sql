...
\restrict vrAXR9zhOBmk9oEiIlZKz4NG1aVuXsTAIESrZnUxUC5gGERJPKcn6yrPGwafVk0
...
74	/peer-reviews/sessions	POST	f	["gcs", "\\uad50\\uc218", "admin"]
75	/peer-evaluations/sessions	GET	f	["gcs", "\\uad50\\uc218", "admin"]
76	/peer-reviews/sessions	GET	f	["gcs", "\\uad50\\uc218", "admin"]
77	/peer-reviews/sessions/{session_id}/members:parse	POST	f	["gcs", "\\uad50\\uc218", "admin"]
78	/peer-reviews/sessions/{session_id}/members:confirm	POST	f	["gcs", "\\uad50\\uc218", "admin"]
79	/peer-reviews/sessions/{session_id}	GET	f	["gcs", "\\uad50\\uc218", "admin"]
80	/peer-evaluations/sessions/{session_id}	PATCH	f	["gcs", "\\uad50\\uc218", "admin"]
81	/peer-reviews/sessions/{session_id}	PATCH	f	["gcs", "\\uad50\\uc218", "admin"]
82	/peer-evaluations/sessions/{session_id}	DELETE	f	["gcs", "\\uad50\\uc218", "admin"]
83	/peer-reviews/sessions/{session_id}	DELETE	f	["gcs", "\\uad50\\uc218", "admin"]
84	/peer-evaluations/sessions/{session_id}/status	PATCH	f	["gcs", "\\uad50\\uc218", "admin"]
85	/peer-reviews/sessions/{session_id}/status	PATCH	f	["gcs", "\\uad50\\uc218", "admin"]
86	/peer-evaluations/sessions/{session_id}/progress	GET	f	["gcs", "\\uad50\\uc218", "admin"]
87	/peer-reviews/sessions/{session_id}/progress	GET	f	["gcs", "\\uad50\\uc218", "admin"]
88	/peer-reviews/sessions/{session_id}/results	GET	f	["gcs", "\\uad50\\uc218", "admin"]
89	/peer-reviews/forms/{token}	GET	f	["gcs", "\\uad50\\uc218", "admin"]
90	/peer-reviews/forms/{token}/submit	POST	f	["gcs", "\\uad50\\uc218", "admin"]
91	/peer-reviews/forms/{token}/my-summary	GET	f	["gcs", "\\uad50\\uc218", "admin"]
\.
...
5	test@example.com	Test User		2026-03-08 07:52:55.228812+00	["user"]	none	\N
9	e2e-professor-peer@gachon.ac.kr	E2E Peer Professor		2026-03-10 06:27:03.966591+00	["\\uac00\\ucc9c\\ub300\\ud559\\uad50"]	none	\N
...
SELECT pg_catalog.setval('public.route_permissions_id_seq', 91, true);
...
\unrestrict vrAXR9zhOBmk9oEiIlZKz4NG1aVuXsTAIESrZnUxUC5gGERJPKcn6yrPGwafVk0
